                     ...
                     COLORREF crBackClr /* CLR_DEFAULT */)
{
	...
	rectDisplay.bottom = rectDisplay.top + rectDisplay.Height() + size.cy;
    ...
    //if ( rectDisplay.right > rectTitle.right-xoffset )
    {
        ...
        CRect textRect(0, 0, rectDisplay.Width(), rectDisplay.Height());
		dc.DrawText(strTitle, &textRect, DT_CENTER | DT_WORDBREAK | DT_NOPREFIX | DT_VCENTER);
        SetCapture();
    }
