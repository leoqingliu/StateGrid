...
#define LINKNAME_STRING     L"\\DosDevices\\SuperFirewallExRate"
#define NTDEVICE_STRING     L"\\Device\\SuperFirewallExRate"
...
--*/
{
    ...
    do
    {
        ...
        //
        NdisInitUnicodeString(&Name, L"SuperFirewallExRate");    // Protocol name
        PChars.Name = Name;
